export const projects = {
    caveat: {
      ...
      'KeystoneJS, MongoDB, React, Typescript, GraphQL, Webpack, SCSS',
        ...
        processDescription: [
            'At the request of Caveat, we have prepared a detailed plan and a list of necessary improvements on the CMS and client side, which includes the minimum that covers the basic needs, and the maximum that reflects all of the client\'s requirements.',
    ...
    veneer: {
      ...
      'Redux, Redux-Saga, Webpack, SCSS, Jest, React, Mobx, Fat client',
        ...
        processDescription: [
            'We organized a transparent process for delivering new versions of the application to users. Developed front-end parts with the client\'s needs in mind. We established transparent relationships between front-end and back-end developers, which allowed us to speed up the development of new features.',
    ...
    'yandex-tv': {
      ...
      'React, Redux, Webpack, SCSS, Jest, Typescript, Node.js, Express.js, Nest.js',
        ...
        processDescription: [
            'Our team was responsible for the relaunch of the new version of YandexTV. Several versions of the product were developed: desktop, mobile, and tablet versions, as well as a version for TV.',
